document.addEventListener("DOMContentLoaded", function() {
    ...
    // Efeito fade-in para o botão de inscrição
    const button = document.getElementById(\'inscricao-button\');
    if (button) {
        button.style.opacity = \'0\'; // Inicialmente invisível
        setTimeout(() => {
            button.style.opacity = \'1\'; // Torna visível com transição
        }, 100);
    }
});
